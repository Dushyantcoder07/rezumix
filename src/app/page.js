...
function SpotlightCard({ children, className = "", onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className={`relative border border-white/10 bg-neutral-900/80 overflow-hidden group ${className}`}
...
const GridBackground = () => (
  <div className="fixed inset-0 z-0 pointer-events-none bg-[#050505]">
    <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:20px_20px] sm:bg-[size:24px_24px] md:bg-[size:32px_32px]" />
    <div className="absolute top-0 left-0 w-full h-[40vh] sm:h-[50vh] md:h-[60vh] bg-blue-600/10 blur-[60px] sm:blur-[90px] md:blur-[120px] rounded-full mix-blend-screen" />
    <div className="absolute bottom-0 right-0 w-full h-[40vh] sm:h-[50vh] md:h-[60vh] bg-purple-600/5 blur-[60px] sm:blur-[90px] md:blur-[120px] rounded-full mix-blend-screen" />
  </div>
);
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 sm:mb-10 md:mb-12 lg:mb-20 text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4">Everything You Need</h2>
            <p className="text-slate-400 text-base sm:text-lg">From application to offer letter, we got you covered.</p>
          </div>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3 sm:space-y-4">
            {faqs.map((item, i) => (
              <div key={i} className="bg-[#0A0A0A] border border-white/5 rounded-xl sm:rounded-2xl overflow-hidden">
                <button
                  onClick={() => toggleFaq(i)}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-neutral-900/50 border border-white/10 p-5 sm:p-6 md:p-7 lg:p-8 rounded-2xl sm:rounded-3xl relative hover:border-white/20 transition-colors">
                <p className="text-slate-200 mb-4 sm:mb-5 md:mb-6 leading-relaxed font-medium text-sm sm:text-base">{t.quote}</p>
                <div className="flex items-center gap-3 sm:gap-4 mt-auto border-t border-white/5 pt-3 sm:pt-4">
                  ...
                  <div className="min-w-0">
                    <div className="text-white font-bold text-sm truncate">{t.author}</div>
